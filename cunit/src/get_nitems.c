...
static void test_kernel_smt_get_nitems_case0(void){
  // answers
...
static void test_kernel_smt_get_nitems_case1(void){
  // answers
...
static void test_kernel_smt_get_nitems_case2(void){
  // answers
...
static void test_kernel_smt_get_nitems_case3(void){
  // answers
...
static void test_kernel_smt_get_nitems_case4(void){
  // answers
...
CUNIT_CI_RUN(
    "kernel_get_nitems",
    CUNIT_CI_TEST(test_kernel_smt_get_nitems_case0),
    CUNIT_CI_TEST(test_kernel_smt_get_nitems_case1),
    CUNIT_CI_TEST(test_kernel_smt_get_nitems_case2),
    CUNIT_CI_TEST(test_kernel_smt_get_nitems_case3),
    CUNIT_CI_TEST(test_kernel_smt_get_nitems_case4)
);
